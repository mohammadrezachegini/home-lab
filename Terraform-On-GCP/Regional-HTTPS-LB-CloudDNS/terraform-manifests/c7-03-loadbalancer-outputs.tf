# This file defines the output variables for the GCP load balancer resources.
# 
# Outputs:
# - mylb_static_ip_address: The static IP address of the load balancer.
# - mylb_backend_service_self_link: The self link of the backend service.
# - mylb_url_map_self_link: The self link of the URL map.
# - mylb_target_http_proxy_self_link: The self link of the target HTTP proxy.
# - mylb_forwarding_rule_ip_address: The IP address of the forwarding rule.
